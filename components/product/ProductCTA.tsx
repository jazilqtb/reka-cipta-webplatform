      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <RevealWrapper>
          ...
          <h2 className="mt-3 text-balance font-ui text-[clamp(1.6rem,2.6vw+1rem,2.5rem)] font-semibold leading-tight text-white">
            Tertarik dengan <span className="italic font-medium text-brand-teal-200">{product.name}</span>?
          </h2>
        ...
        <RevealWrapper variant="reveal-up" delay={100}>
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            >
              <FlaskIcon size={18} weight="duotone" className="transition-transform duration-300 group-hover:scale-110" aria-hidden="true" />
              Minta Sampel
            </Link>
            <Link
              href={quotationHref}
            ...
            >
              <HandshakeIcon size={18} weight="duotone" className="transition-transform duration-300 group-hover:scale-110" aria-hidden="true" />
              Dapatkan Penawaran
