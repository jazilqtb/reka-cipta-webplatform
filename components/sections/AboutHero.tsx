...
// gradient diklaster di atas, ParallaxBlob, breadcrumb di dalam Hero,
    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-ink-950 to-ink-900 px-4 pb-14 pt-14 md:pb-20 md:pt-20">
      <div
        ...
        style={{
          backgroundImage:
            ...
            'radial-gradient(circle 300px at 90% 0%, rgba(27,191,170,0.16), transparent)',
        }}
        aria-hidden="true"
      />
      <ParallaxBlob range={28} className="left-[12%] top-[-12%] h-64 w-64 bg-brand-teal-400/14" />
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <h1 className="mt-3 max-w-2xl text-balance font-ui text-[clamp(2rem,3.6vw+1rem,3.5rem)] font-semibold leading-[1.1] tracking-tight text-white">
          ...
          <span className="italic font-medium text-brand-teal-300">Transparansi dan Konsistensi</span>
        </h1>
